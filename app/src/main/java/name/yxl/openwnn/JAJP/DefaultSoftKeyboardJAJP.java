...
public class DefaultSoftKeyboardJAJP extends DefaultSoftKeyboard {
    private static final String TAG = DefaultSoftKeyboardJAJP.class.getSimpleName();
    ...
    /** @see name.yxl.openwnn.DefaultSoftKeyboard#createKeyboards */
    ...
    public void changeKeyMode(int keyMode) {
     ...
     /** @see name.yxl.openwnn.DefaultSoftKeyboard#initView */
    ...
    /** @see name.yxl.openwnn.DefaultSoftKeyboard#changeKeyboard */
    ...
    /** @see name.yxl.openwnn.DefaultSoftKeyboard#changeKeyboardType */
    ...
    /** @see name.yxl.openwnn.DefaultSoftKeyboard#onKey */
    ...
    /** @see name.yxl.openwnn.DefaultSoftKeyboard#setPreferences */
    ...
    /** @see name.yxl.openwnn.DefaultSoftKeyboard#onUpdateState */
    ...
    /** @see name.yxl.openwnn.DefaultSoftKeyboard#setHardKeyboardHidden */
